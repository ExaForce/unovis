...
export const variables = injectGlobal`
  :root {
    ...
    /* Node Selection */
    --vis-sankey-node-selection-rect-stroke-width: 1.5px;
    --vis-sankey-node-selection-rect-stroke-opacity: 0.6;
    --vis-sankey-node-selection-rect-radius: 2px;
    /* Node Labels */
...
export const nodeSelectionRect = css`
  ...
  fill: none;
  stroke-width: var(--vis-sankey-node-selection-rect-stroke-width);
  stroke-opacity: var(--vis-sankey-node-selection-rect-stroke-opacity);
  rx: var(--vis-sankey-node-selection-rect-radius);
  ry: var(--vis-sankey-node-selection-rect-radius);
`
